    ...
    if ($result = mysqli_query($conn, $query)) {
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                {
                    $.ajax({
                        url:"dataAll.php?code=<?php echo $_POST['filterData']; ?>&month=<?php echo $_POST['month']; ?>&year=<?php echo $_POST['year']; ?>&dateFrom=<?php echo $_POST['dateFrom']; ?>&dateTo=<?php echo $_POST['dateTo']; ?>",
                        method:"POST",
                        data:{action:'fetch'},
                        dataType:"JSON",
